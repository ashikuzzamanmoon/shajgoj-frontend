                              ...
                              {item.megaMenu.map((section) => (
                                <div key={section.title}>
                                  <button
                                    ...
                                    className="w-full flex justify-between items-center py-1 font-semibold text-gray-700 text-left"
                                  >
                                    ...
                                    <div className="pl-2 mt-1 space-y-1">
                                      {section.links.map((link) => (
                                        <Link
                                          key={link.name}
                                          href={link.href}
                                          className="block text-sm text-gray-500 hover:text-pink-500 py-1"
                                        >
                                          {link.name}
                                        </Link>
                                      ))}
